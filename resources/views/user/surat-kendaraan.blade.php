...
<head>
    <meta charset="UTF-8">
    <title>Permohonan Peminjaman Kendaraan</title>
...
<body>
    ...
    <p>
        ...
        Dengan ini mengajukan permohonan peminjaman kendaraan
    ...
    <ol>
        ...
        <li>
            Menggunakan kendaraan sesuai jadwal yang telah disetujui.
        </li>

        <li>
            Menjaga kebersihan, keamanan, dan ketertiban selama
            penggunaan kendaraan.
        </li>

        <li>
            Bertanggung jawab atas seluruh fasilitas kendaraan yang dipinjam.
        </li>

        <li>
            Mengembalikan kendaraan dalam keadaan bersih, rapi,
            dan baik setelah kegiatan selesai.
        </li>
