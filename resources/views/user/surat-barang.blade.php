...
<head>
    <meta charset="UTF-8">
    <title>Permohonan Peminjaman Barang</title>
    ...
    <style>
        ...
        table.barang td:first-child {
            width: 50px;
            text-align: center;
        }

        table.barang td:nth-child(3) {
            width: 120px;
            text-align: center;
        }
...
<body>
    ...
    <p>
        ...
        Dengan ini mengajukan permohonan peminjaman barang inventaris
        untuk pelaksanaan kegiatan sebagai berikut :
    ...
    <ol>
        ...
        <li>
            Menggunakan barang sesuai jadwal yang telah disetujui.
        </li>

        <li>
            Menjaga kebersihan, keamanan, dan ketertiban selama penggunaan.
        </li>

        <li>
            Bertanggung jawab atas seluruh barang yang dipinjam.
        </li>

        <li>
            Mengembalikan barang dalam keadaan baik, bersih,
            dan tepat waktu.
        </li>

        <li>
            Bersedia mengganti atau memperbaiki apabila terjadi
            kerusakan atau kehilangan akibat kelalaian.
        </li>
